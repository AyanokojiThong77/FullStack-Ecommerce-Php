...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
        ...
        <div class="inputBox">
            <span>Hình ảnh 01 (bắt buộc)</span>
            <input type="file" name="image_01" accept="image/jpg, image/jpeg, image/png, image/webp" class="box" required>
        </div>
        <div class="inputBox">
            <span>Hình ảnh 02 (bắt buộc)</span>
            <input type="file" name="image_02" accept="image/jpg, image/jpeg, image/png, image/webp" class="box" required>
        </div>
        <div class="inputBox">
            <span>Hình ảnh 03 (bắt buộc)</span>
...
<section class="show-products">
   ...
   <h1 class="heading">Các sản phẩm đã thêm</h1>
   ...
   <div class="box">
      ...
      <div class="price">đ<span><?= number_format($fetch_products['price'], 0, ',', '.'); ?></span>/-</div>
      <div class="details"><span><?= $fetch_products['details']; ?></span></div>
      <div class="flex-btn">
         <a href="update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">Cập nhật</a>
         <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này không?');">Xóa</a>
      </div>
   </div>
   <?php
         }
