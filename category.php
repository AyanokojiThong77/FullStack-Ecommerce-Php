...
<section class="products">
   ...
   <?php
     ...
     // Truy vấn cơ sở dữ liệu với tên sản phẩm không dấu
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(name, 'à', 'a'), 'á', 'a'), 'ả', 'a'), 'ã', 'a'), 'ạ', 'a'), 'â', 'a') LIKE :category"); 
